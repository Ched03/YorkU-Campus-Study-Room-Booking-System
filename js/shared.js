// ===== SHARED DATA =====
const ROOMS = [
  { id: 'r101', number: 'Room 101', floor: 'Floor 1', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM', '3:00 PM', '2:00 PM', '1:00 PM', '12:00 PM', '11:00 AM', '10:00 AM', '9:00 AM', '8:00 AM'] },
  { id: 'r102', number: 'Room 102', floor: 'Floor 1', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r103', number: 'Room 103', floor: 'Floor 1', capacity: 4, type: 'Group', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r104', number: 'Room 104', floor: 'Floor 1', capacity: 6, type: 'Group', status: 'booked', time: ['4:00 PM',  ] },
  { id: 'r105', number: 'Room 105', floor: 'Floor 1', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r201', number: 'Room 201', floor: 'Floor 2', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r202', number: 'Room 202', floor: 'Floor 2', capacity: 1, type: 'Individual', status: 'maintenance', time: ['4:00 PM',  ] },
  { id: 'r203', number: 'Room 203', floor: 'Floor 2', capacity: 4, type: 'Group', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r204', number: 'Room 204', floor: 'Floor 2', capacity: 8, type: 'Group', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r205', number: 'Room 205', floor: 'Floor 2', capacity: 1, type: 'Individual', status: 'booked', time: ['4:00 PM',  ] },
  { id: 'r301', number: 'Room 301', floor: 'Floor 3', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r302', number: 'Room 302', floor: 'Floor 3', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM',  ] },
  { id: 'r303', number: 'Room 303', floor: 'Floor 3', capacity: 6, type: 'Group', status: 'available', time: ['4:00 PM'] },
  { id: 'r304', number: 'Room 304', floor: 'Floor 3', capacity: 4, type: 'Group', status: 'available', time: ['4:00 PM' ] },
  { id: 'r305', number: 'Room 305', floor: 'Floor 3', capacity: 1, type: 'Individual', status: 'available', time: ['4:00 PM'] },
];
